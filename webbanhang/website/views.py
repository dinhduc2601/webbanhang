...
class Home(View):
    ...
    def get(self, request):
        ...
        .order_by('-count')[:8]
        data = {"top_products": top_products, "sanpham": sanpham, "slide": slide, "bannertop": bannertop, "bannermid": bannermid, "bannerbottom": bannerbottom, "tintuc": tintuc, "title": "Nội thất hiện đại và phong cách!"}
